...
" className="thumb-link" title="Anjali Sharma Radio Record Podcast - The Power of Self Belief" data-size="1050x700">
                                    ...
                                    <div className="item-folio__text">
                                        <h3 className="item-folio__title">
                                            Radio Podcast - The Power of Self Belief
                  </h3>
                                        <p className="item-folio__cat">
                                            Personality Development
                  </p>
                                    </div>
                                    <a href="https://open.spotify.com/episode/1qxy0PH454DyNLMpI2wneU?si=pyBco1pWSVKasiLKJUSPYA#_=_" className="item-folio__project-link" title="Project link">
                            ...
                            <div className="masonry__brick">
                                <div className="item-folio">
                                    ...
                                    <div className="item-folio__text">
                                        <h3 className="item-folio__title">
                                            Offical Humans of VIT Vellore Feature</h3>
                                        <p className="item-folio__cat">
                                            Storytelling</p>
                                    </div>
                                    <a href="https://www.behance.net/" className="item-folio__project-link" title="Project link">
